    ...
    public class EdgeProfile : Profile
    {
        public EdgeProfile(ICommonRepository commonRepository)
        {
            CreateMap<EdgeAm, Edge>()
                ...
                .ForMember(dest => dest.FromNodeId, opt => opt.MapFrom(src => commonRepository.ResolveId(src.FromNodeId, src.FromNodeIri)))
                .ForMember(dest => dest.ToNodeId, opt => opt.MapFrom(src => commonRepository.ResolveId(src.ToNodeId, src.ToNodeIri)))
                ...
                .ForMember(dest => dest.FromConnectorIri, opt => opt.MapFrom(src => commonRepository.ResolveIri(src.FromConnectorId, src.FromConnectorIri)))
                .ForMember(dest => dest.ToConnectorIri, opt => opt.MapFrom(src => commonRepository.ResolveIri(src.ToConnectorId, src.ToConnectorIri)))
                .ForMember(dest => dest.FromNodeIri, opt => opt.MapFrom(src => commonRepository.ResolveIri(src.FromNodeId, src.FromNodeIri)))
                .ForMember(dest => dest.ToNodeIri, opt => opt.MapFrom(src => commonRepository.ResolveIri(src.ToNodeId, src.ToNodeIri)))
