...
namespace Mb.Core.Migrations
{
    ...
    [Migration("20210804125253_TransportAndInterfaceCnfigurationNameAndSemanticReference")]
    partial class TransportAndInterfaceCnfigurationNameAndSemanticReference
    {
            ...
            modelBuilder.Entity("Transport_Attribute", b =>
                {
                    ...
                    b.HasOne("Mb.Models.Data.Transport", null)
                        .WithMany()
                        .HasForeignKey("TransportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
