...
namespace Mb.Services.Services
{
    public class NodeService : INodeService
    {
        ...
        public NodeService(INodeRepository nodeRepository, IMapper mapper, IProjectRepository projectRepository, IConnectorRepository connectorRepository, IHttpContextAccessor contextAccessor)
        {
