...
namespace ModelBuilder.Models.Tests
{
    ...
    {
        [Theory]
        [InlineData(null, @"https://rdf.equinor.com/sor/mimir/ID0b805fa8-1daa-4871-ac51-832607d52bbe", "equinor.com")]
        ...
        [Theory]
        [InlineData("invalidDomain_0b805fa8-1daa-4871-ac51-832607d52bbe", "invalidDomain", "invalidDomain")]
