...
//    [InlineData(new "EE73A40C-CB90-4183-8126-A1AFB01CA3A9", false)]
...
//    public void CreateOrUseIdAndIri_Returns_Correct_Ids(Guid fromId, string fromIri, string expectedId, string expectedIri)
//    {
...
//        Assert.Equal(expectedId, replacement2.ToId.ToString());
...
//    public void CreateOrUseIdAndIri_Id_Before_Uri(Guid fromId, string fromIri, string expectedId, string expectedIri)
//    {
//        var replacement = new ReplacementId { FromId = fromId, FromIri = fromIri };
//        var replacement2 = _commonRepository.CreateOrUseIdAndIri(replacement);
//        Assert.Equal(expectedId, replacement2.ToId.ToString());
