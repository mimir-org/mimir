...
namespace Mb.Models.Configurations
{
    public class AspectObjectConfiguration : IEntityTypeConfiguration<AspectObject>
    {
        public void Configure(EntityTypeBuilder<AspectObject> builder)
        {
            ...
            builder.Property(p => p.Project).HasColumnName("ProjectId").IsRequired();
            builder.Property(p => p.Rds).HasColumnName("Rds").IsRequired(false);
            builder.Property(p => p.Description).HasColumnName("Description").IsRequired(false);
            builder.Property(p => p.TypeReference).HasColumnName("TypeReferenceString");
            ...
            builder.Property(p => p.LibraryType).HasColumnName("LibraryTypeId").IsRequired();
            ...
            builder.Property(p => p.MainProject).HasColumnName("MasterProjectId").IsRequired();
