...
namespace Mb.Models.Data
{
    public class LibraryType
    {
        ...
        public ICollection<TerminalType> Terminals { get; set; }
        ...
        {
            Terminals = string.IsNullOrEmpty(TerminalJson) ? null : JsonConvert.DeserializeObject<ICollection<TerminalType>>(TerminalJson);
