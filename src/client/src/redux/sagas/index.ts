...
import {
  ...
  IMPORT_PROJECT,
  LOCK_UNLOCK_NODE,
  SET_LOCK_UNLOCK_NODE_ATTRIBUTE,
  COMMIT_PROJECT,
  SET_LOCK_UNLOCK_NODE_TERMINAL_ATTRIBUTE,
  SET_LOCK_UNLOCK_COMPOSITE_ATTRIBUTE,
  SET_LOCK_UNLOCK_INTERFACE_ATTRIBUTE,
  SET_LOCK_UNLOCK_INTERFACE_TERMINAL_ATTRIBUTE,
  SET_LOCK_UNLOCK_TRANSPORT_ATTRIBUTE,
  SET_LOCK_UNLOCK_TRANSPORT_TERMINAL_ATTRIBUTE,
