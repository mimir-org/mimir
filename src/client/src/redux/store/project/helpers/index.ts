...
export { getEdgeInterfaceAttributeMap } from "./getEdgeInterfaceAttributeMap";
export { getEdgeInterfaceTerminalAttributeMap } from "./getEdgeInterfaceTerminalAttributeMap";
