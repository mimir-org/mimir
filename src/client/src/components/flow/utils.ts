import { Project, Node, Connector, CONNECTOR_TYPE, Edge, EDGE_TYPE } from '../../models/project';
import { Elements, FlowElement, Position, HandleType, ArrowHeadType } from "react-flow-renderer";
...
export const CreateElementEdge = (edge: Edge, fromNode: Node, toNode: Node): FlowElement => {
    let elem =
    {
        id: edge.id,
