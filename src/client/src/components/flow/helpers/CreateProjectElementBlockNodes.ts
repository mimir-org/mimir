import { Project, EDGE_TYPE, RELATION_TYPE, EdgeType } from "../../../models/project";
import { Elements } from "react-flow-renderer";
import { CreateElementEdge, CreateElementBlockNode, CreateElementNode, GetReactFlowBoundingRectData } from ".";

const CreateProjectElementBlockNodes = (project: Project, nodeId: string): Elements => {
