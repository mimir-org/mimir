...
interface Props {
  ...
  onConnectorClick: (conn: Connector, isInput: boolean, isElectroView: boolean, isOffPage: boolean) => void;
}
  ...
  return (
    ...
    >
      <BlockChildHeader
        ...
        onConnectorClick={(c, isInput, isElectroView, isOffPage) => onConnectorClick(c, isInput, isElectroView, isOffPage)}
