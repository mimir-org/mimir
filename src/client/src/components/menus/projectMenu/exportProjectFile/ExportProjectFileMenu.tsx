...
import { commonStateSelector, projectStateSelector, useAppDispatch, useAppSelector } from "store";
...
export const ExportProjectFileMenu = () => {
  ...
  const project = useAppSelector<ProjectState>(projectStateSelector);
  ...
  const onAction = () => OnExportProjectFileClick(dispatch, project.project, fileName, parser.id);
