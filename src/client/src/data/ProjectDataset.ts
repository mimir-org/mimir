import { NODE_TYPE, ICON_TYPE, CONNECTOR_TYPE, RELATION_TYPE, TERMINAL_CATEGORY, TERMINAL_TYPE } from "../models/project";
                ...
                nodes: [
                    {
                        ...
                        position: { x: 150, y: 5 },
                        connectors: [
                            { id: createId(), name: "", type: CONNECTOR_TYPE.OUTPUT, relationType: RELATION_TYPE.PartOf, terminalCategory: TERMINAL_CATEGORY.NotSet, terminalType: TERMINAL_TYPE.NotSet },
                        ],
                            ...
                            connectors: [
                                {
                                    ...
                                    name: "",
                                    type: CONNECTOR_TYPE.OUTPUT,
                                    relationType: RELATION_TYPE.PartOf,
                                    terminalCategory: TERMINAL_CATEGORY.NotSet,
                                    terminalType: TERMINAL_TYPE.NotSet
                                },
                            ],
                            attributes: [
                                {
                        ...
                        },
                        {
                            ...
                            connectors: [
                                ...
                                },
                                {
                                    ...
                                    name: "",
                                    type: CONNECTOR_TYPE.OUTPUT,
                                    relationType: RELATION_TYPE.Relation,
                                    terminalCategory: TERMINAL_CATEGORY.NotSet,
                                    terminalType: TERMINAL_TYPE.NotSet
                                },
                            ],
