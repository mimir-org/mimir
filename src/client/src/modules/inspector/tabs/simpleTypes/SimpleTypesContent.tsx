...
import { Dropdown } from "../parameters/styled/dropdown/parameter";
import { CombinedAttributeFilter, Connector, Node } from "../../../../models";
import { GetAttributeCombinations, GetParametersColor } from "../parameters/helpers";
import { Menu, Header } from "../parameters/styled";
import { OnChangeFilterChoice, OnClearAllFilters } from "../parameters/handlers";
import { FilterDict } from "../parameters/redux/types";
import { ParameterRow } from "../parameters";
...
const SimpleTypesContent = ({ element, elementIsLocked }: Props) => {
...
export default SimpleTypesContent;
