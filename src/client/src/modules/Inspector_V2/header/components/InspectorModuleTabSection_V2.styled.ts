...
export const Inspector_V2TabsWrapper = styled.div`
  display: flex;
  flex-direction: row;
  height: 40px;
  width: inherit;
...
interface InspectorModuleTabs_V2Props {
    isActive: boolean;
}

export const Inspector_V2TabHeader = styled.div<InspectorModuleTabs_V2Props>`
  display: flex;
  min-width: 73px;
...
export const Inspector_V2HeaderText = styled.p`
  color: ${Color.BLACK};
